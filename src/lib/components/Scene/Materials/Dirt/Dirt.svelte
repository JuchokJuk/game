<script lang="ts">
	...
	const texture = useLoader(TextureLoader).load("models/Terrain denoised/Dirt ground baked.png");
	const glitchedTexture = useLoader(TextureLoader).load("models/Terrain glitched/Dirt ground baked.png");
