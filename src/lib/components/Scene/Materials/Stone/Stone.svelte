<script lang="ts">
	...
	const texture = useLoader(TextureLoader).load("models/Terrain denoised/Stones baked.png");
	const glitchedTexture = useLoader(TextureLoader).load("models/Terrain glitched/Stones baked.png");
