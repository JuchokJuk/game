<script lang="ts">
	...
	const texture = useLoader(TextureLoader).load("models/Terrain denoised/Grass ground baked.png");
	const glitchedTexture = useLoader(TextureLoader).load("models/Terrain glitched/Grass ground baked.png");
